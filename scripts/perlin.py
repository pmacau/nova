...
def create_textured_map(terrain):
    ...
    texture_atlas = Image.open("../data/retextures/tile/tileset.png")
    for row in range(height - 1):
        for col in range(width - 1):
            ...
            # tile_row, tile_col = texture_map[tile_str]
...
if __name__ == "__main__":
    ...
    plt.axis("off")
    plt.savefig("../data/maps/map2.png", bbox_inches='tight', pad_inches=0, dpi=300)
